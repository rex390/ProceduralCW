...
public:
	...
	int GetMode();
	//movement of digger
	void IncreaseDiggerX();
	void DecreaseDiggerX();
	void IncreaseDiggerZ();
	void DecreaseDiggerZ();
...
private:
	...
	ID3D11Buffer* m_ModeBuffer;
	ID3D11Buffer* m_matrixBuffer;
	ID3D11Buffer* m_lightBuffer;
	int DrawMode,DiggerPositionX,DiggerPositionZ,DiggerWidthHeight;
};
